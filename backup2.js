...
function init() {
    ...
    function placeShipVertical(ship){
        let num = randomNum()
        let y = Math.floor(Math.random() * 5)
        for(let i = 0; i < ship.length; i++){
            gameBoard[i + y][num] = ship[i] 
            if(ship.length === 2 && gameBoard[i + y][num] !== ' ' && gameBoard[i + y + 1][num] !== ' '){
                while(ship.length === 2 && gameBoard[i + y][num] !== ' ' && gameBoard[i + y + 1][num] !== ' '){
                    num = randomNum()
                    y = Math.floor(Math.random() * 5)
                    gameBoard[i + y][num] = ship[i]  
                }
            } else if(ship.length === 3 && gameBoard[i + y][num] !== ' ' && gameBoard[i + y + 1][num] !== ' '  && gameBoard[i + y + 2][num] !== ' '){
                while(ship.length === 3 && gameBoard[i + y][num] !== ' ' && gameBoard[i + y + 1][num] !== ' '  && gameBoard[i + y + 2][num] !== ' '){
                    num = randomNum()
                    y = Math.floor(Math.random() * 5)
                    gameBoard[i + y][num] = ship[i]  
                }
            } else if (ship.length === 4 && gameBoard[i + y][num] !== ' ' && gameBoard[i + y + 1][num] !== ' '  && gameBoard[i + y + 2][num] !== ' ' && gameBoard[i + y + 3][num] !== ' ') {
                while(ship.length === 4 && gameBoard[i + y][num] !== ' ' && gameBoard[i + y + 1][num] !== ' '  && gameBoard[i + y + 2][num] !== ' ' && gameBoard[i + y + 3][num] !== ' '){
                    num = randomNum()
                    y = Math.floor(Math.random() * 5)
                    gameBoard[i + y][num] = ship[i] 
                }
            } else if (ship.length === 5 && gameBoard[i + y][num] !== ' ' && gameBoard[i + y + 1][num] !== ' '  && gameBoard[i + y + 2][num] !== ' ' && gameBoard[i + y + 3][num] !== ' ' && gameBoard[i + y + 4][num] !== ' '){
                while(ship.length === 5 && gameBoard[i + y][num] !== ' ' && gameBoard[i + y + 1][num] !== ' '  && gameBoard[i + y + 2][num] !== ' ' && gameBoard[i + y + 3][num] !== ' ' && gameBoard[i + y + 4][num] !== ' '){
                    num = randomNum()
                    y = Math.floor(Math.random() * 5)
                    gameBoard[i + y][num] = ship[i]  
                }
    ...
    function placeShipshorizontal(ship) {
        let num = randomNum()
        let y = Math.floor(Math.random() * 5)
        for(let i = 0; i < ship.length; i++){
            gameBoard[num][i + y] = ship[i]
            if(ship.length === 2 && gameBoard[num][i + y] !== ' ' && gameBoard[num][i + y + 1] !== ' ') {
                while(ship.length === 2 && gameBoard[num][i + y] !== ' ' && gameBoard[num][i + y + 1] !== ' '){
                    num = randomNum()
                    y = Math.floor(Math.random() * 5)
                    gameBoard[num][i + y] = ship[i]
                }
            } else if (ship.length === 3 && gameBoard[num][i + y] !== ' ' && gameBoard[num][i + y + 1] !== ' '  && gameBoard[num][i + y + 2] !== ' '){
                while(ship.length === 3 && gameBoard[num][i + y] !== ' ' && gameBoard[num][i + y + 1] !== ' '  && gameBoard[num][i + y + 2] !== ' '){
                    num = randomNum()
                    y = Math.floor(Math.random() * 5)
                    gameBoard[num][i + y] = ship[i]
                }
            } else if (ship.length === 4 && gameBoard[num][i + y] !== ' ' && gameBoard[num][i + y + 1] !== ' '  && gameBoard[num][i + y + 2] !== ' ' && gameBoard[num][i + y + 3] !== ' ') {
                while(ship.length === 4 && gameBoard[num][i + y] !== ' ' && gameBoard[num][i + y + 1] !== ' '  && gameBoard[num][i + y + 2] !== ' ' && gameBoard[num][i + y + 3] !== ' '){
                    num = randomNum()
                    y = Math.floor(Math.random() * 5)
                    gameBoard[num][i + y] = ship[i]
                }
            } else if (ship.length === 5 && gameBoard[num][i + y] !== ' ' && gameBoard[num][i + y + 1] !== ' '  && gameBoard[num][i + y + 2] !== ' ' && gameBoard[num][i + y + 3] !== ' ' && gameBoard[num][i + y + 4] !== ' ') {
                while(ship.length === 5 && gameBoard[num][i + y] !== ' ' && gameBoard[num][i + y + 1] !== ' '  && gameBoard[num][i + y + 2] !== ' ' && gameBoard[num][i + y + 3] !== ' ' && gameBoard[num][i + y + 4] !== ' '){
                    num = randomNum()
                    y = Math.floor(Math.random() * 5)
                    gameBoard[num][i + y] = ship[i]
                }
...
// function placeShipVerticle(){
    //     ships.forEach(ship => {
    //         let num = randomNum()
    //         for(let i = 0; i < ship.length; i++){
    //             gameBoard[i][num] = ship[i]
    //             if(gameBoard[i][num] !== ""){
    //                 num = randomNum()
    //                 gameBoard[i][num] = ship[i]
    //                 continue;
    ...
    // const condition = ship.length === 2 && gameBoard[num][i + y] !== ' ' && gameBoard[num][i + y + 1] !== ' ' ||
    // ship.length === 3 && gameBoard[num][i + y] !== ' ' && gameBoard[num][i + y + 1] !== ' '  && gameBoard[num][i + y + 2] !== ' ' ||
    // ship.length === 4 && gameBoard[num][i + y] !== ' ' && gameBoard[num][i + y + 1] !== ' '  && gameBoard[num][i + y + 2] !== ' ' && gameBoard[num][i + y + 3] !== ' ' ||
    // ship.length === 5 && gameBoard[num][i + y] !== ' ' && gameBoard[num][i + y + 1] !== ' '  && gameBoard[num][i + y + 2] !== ' ' && gameBoard[num][i + y + 3] !== ' ' && gameBoard[num][i + y + 4] !== ' '
    ...
    // const condition = ship.length === 2 && gameBoard[i + y][num] !== ' ' && gameBoard[i + y + 1][num] !== ' ' ||
    // ship.length === 3 && gameBoard[i + y][num] !== ' ' && gameBoard[i + y + 1][num] !== ' '  && gameBoard[i + y + 2][num] !== ' ' ||
    // ship.length === 4 && gameBoard[i + y][num] !== ' ' && gameBoard[i + y + 1][num] !== ' '  && gameBoard[i + y + 2][num] !== ' ' && gameBoard[i + y + 3][num] !== ' ' ||
    // ship.length === 5 && gameBoard[i + y][num] !== ' ' && gameBoard[i + y + 1][num] !== ' '  && gameBoard[i + y + 2][num] !== ' ' && gameBoard[i + y + 3][num] !== ' ' && gameBoard[i + y + 4][num] !== ' '
